...
\item Remaining site infrastructure (high-bandwidth optical network, surveying, trenching) finalized.  HERA 128 construction completed by Oct. 2016.
...
\begin{itemize}[itemsep=-4pt]
\item HERA 127 complete. Science observations begin Oct. 2016 using the PAPER correlator, ending in May 2017.
\item Deployment of HERA 331. New node electronics and a 331-element, GPU-based correlator in the Karoo Array Processing Building (KAPB) installed.  Construction finished Oct. 2017.
\item New data storage infrastructure in the KAPB installed.
\item UPenn analysis cluster upgraded. 
\item Analysis of HERA 127 observations using proven delay-spectrum analysis techniques, publishing results constraining the timing and duration of reionization. 
...
\begin{itemize}[itemsep=-4pt]
\item HERA 331 complete. Science observations begin Oct. 2017. 
...
\item High-fidelity maps/data cubes of the HERA field for cross-correlation studies created and released to the community. %JCP maybe not released to the community this year?
...
shows a breakdown per instituition per funded activity type:   development, deployment/testing, management, commissioning/support, and calibration/analysis/science.
