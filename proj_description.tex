...
This HERA-331 proposal targets a 331-element array that incorporates
...
Figure \ref{fig:config} shows the antenna configuration, including the tall pole locations and \ref{fig:optics} shows a cross-section of an element.

% AAARRGGHH!
\begin{figure}[h]
	\centering
	\begin{subfigure}[b]{0.35\textwidth}
		\includegraphics[width=\textwidth]{plots/Engineering/hex_61.png} % XXX update this
		\caption{Configuration of the 331-element array.  Note the rectangular container to scale on right.}
		\label{fig:config}
	\end{subfigure}
	\quad
