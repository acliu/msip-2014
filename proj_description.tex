...
\Caption{-0.2in}{0.9}{-0.2in}{\small Left: HERA's power-spectrum sensitivity (solid)
...
\Caption{-0.2in}{0.9}{-0.2in}{\small Left:
...
\Caption{-0.2in}{0.9}{-0.2in}{\small Timeline of project}
\label{fig:timeline}
\end{figure}
...
{\bf HERA-331 basic parameters:} maximum baseline 250m (naturally weighted synthesized beam FWHM = $24'$),
element diameter = 14m (FoV FWHM = 9$^o$?? at 150MHz), frequency range = 50 MHz to 225 MHz ($z_{HI} = 28 to 5.3)$, 
system temperature = 350K?? at 150MHz (point source rms = 50 $\mu$Jy in 100hrs), spectral channel width = 97.7kHz??,
instantaneous bandwidth = 100MHz??, other?
