...
on the power spectrum of 21~cm emission from reionization \Mycitep{parsons_et_al2013}\footnote{Throughout the proposal, we have indicated work by members of this collaboration in bold.}. PAPER
...
\Caption{-0.1in}{0.9}{-0.1in}{\small Timeline of project}
\label{fig:timeline}
\end{figure}
...
\begin{center}
 \begin{tabular}{ll}
    ...
    Maximum outrigger baseline length & 1200 m \\
