...
Study of the evolution of the neutral IGM, and the sources of reionization, has been a high priority in 
astronomy over the last decade, and is a major driver for future large telescopes.  Recent 
measurements from the {\it Hubble Space Telescope} have pinned down the bright end of the galaxy luminosity function 
at $z \la 8$ \citep{bouwens_et_al2010, schenker_et_al2013} and have begun to detect a few sources at even greater 
...
Models of the evolution of the primordial IGM can be built from these observations. The most recent compilation by
\citep{robertson_2013} suggests that the IGM may have been substantially neutral even at 
$z \sim 7$--8 (as high as $F_{HI} \sim 0.5$), with a tail of finite ionization ($\sim 0.1$) extending to high 
redshift ($z \sim 15$), driven by very early galaxy formation.  The extrapolation to 
$z>8$ is particularly uncertain, as only a handful of candidate galaxies have been found during that earlier 
era (c.f. \citealt{oesch_et_al2013}).  Unfortunately, these important methods have limited reach: (i) Gunn-Peterson
...
The University of Washington team lead the development of the MWA Monitor and Control system (M\&C; \citealt{tingay_et_al2013_trunc}), and the HERA M\&C will be a direct port of this very successful software. The M\&C system is responsible for observation scheduling, array startup and shutdown, and monitoring of all the field systems. In the process the M\&C system collects large amounts of meta data which are crucial for identifying subtle biases in the cosmological data. 

The MWA M\&C system already has the capacity to handle the HERA instrument and meta data, and given the shared heritage of many of the systems adaptation for HERA will be straightforward. 
