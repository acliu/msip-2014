...
to 30), when the first stars and black holes warm the primordial IGM. 
...
The ability of HERA to image makes an exciting range of cross-correlation science possible.  For example, HERA will provide the large-scale reionization environment for pointed JWST or ALMA 
...
% XXX begin with a clear flow from requirements to spec to design
