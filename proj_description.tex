...
\caption{\small 
Left panels: simulated $21\,\textrm{cm}$ brightness temperature distributions at $z=11.5$, $10.5$, $9.5$, and $8.5$, each box measuring $\sim 280 \times 280\,h^{-1}\textrm{Mpc}$.  Right panel: Corresponding evolution of the $21\,\textrm{cm}$ power spectrum.  HERA will characterize the power spectrum in detail (\S\ref{sec:detectPspec}) as well as provide images of the ionized bubbles (\S\ref{sec:imaging_HI}).
}\label{fig:EoRsims} \end{figure}
