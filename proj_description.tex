...
(1) Probes using the Ly$\alpha$ transition can study only the tail-end of reionization, 
thanks to the extreme optical depth of that transition, (2) inferences from galaxy populations require strong assumptions 
...
spectrum across a wide range of k modes and redshifts \citep{pober_et_al2014}.  Figure \ref{fig:eor_pspec} shows a $z=9$ power spectrum modeled by the 21cmFAST software \citep{mesinger_et_al2011}, 
...
resultant sensitivity of imaging in a foreground avoidance scheme, assuming a conservative 1MHz of effective bandwidth, or 12 Mpc along the line of 
