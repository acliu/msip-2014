...
end of the dark ages (see section ?? on dark ages).  HERA will have the low frequency coverage and
...
the integrated  global ionization profile versus redshift (see section ?? on parameter estimation). 
...
spectrum across a wide range of k modes and redshifts \citep{pober_et_al2014}.  In Figure we show 
