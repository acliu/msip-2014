...
%binned in local sidereal time, and averaged. Averaging in this manner
%will allow for a decrease in data volume by a factor of the number of
%days included in each block, which is limited by the timescale of
%calibration drifts, as averaging differently-calibrated data may
%result in unwanted artifacts. This intermediate averaging scheme will
%also generate an accurate sky model for the instrument once
...
performs the next round of calibration 
