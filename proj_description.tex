...
\item Measurements of CMB temperature fluctuations \citep{planck_et_al2013} and large scale 
polarization anisotropies \citep{page_et_al2007}.
...
(1) Gunn-Peterson
and related effects probe only the tail-end of reionization, (2) many assumptions 
are needed regarding stellar populations, the escape fraction of UV photons from the galaxies, and the
clumping of the IGM, and (3) the CMB provides only an integral measure of ionization back to recombination. 
Moreover, many of these indirect observations are in tension with one another, underscoring the difficulty of
