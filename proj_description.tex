...
obtain a marginal detection of the HI 21cm signal within two years. 
...
is a build-out of HERA-127 as its eastern edge.
...
HERA's science requirements dictate a maximum analog signal pathlength.  As a consequence,
...
A prime example of this is CASPER, which has been at the core of the digital development effort
for PAPER, and involves undergraduate, RAL interns, grad students, and
...
% XXX somehting extra about hera activities.
...
While UC Berkeley will lead core instrument development and construction for HERA,
each institution will contribute necessary instrumentation, computing,
monitor/control, data management, and analysis software to the project.  
Students and postdocs at all institutions will take a leading role in development and
testing (participating in critical design reviews), and 
contribute to deployment, commissioning, and observing.  This acts as an
continuation of
 the HERA
collaboration's uninterrupted commitment to
